...
svn co https://github.com/281677160/openwrt-package/branches/master/netdata packages/admin/netdata
rm -rf luci/luci-app-netdata
svn co https://github.com/281677160/openwrt-package/branches/master/luci-app-netdata luci/applications/luci-app-netdata
